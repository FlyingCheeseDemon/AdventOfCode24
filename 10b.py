# actually this is identical to before, now I just don't care about whether I have visited a nine before or not
map = []
...
def scan(position,map,current_number,score):
    ...
    for direction in directions:
        ...
        if seeing == current_number + 1:
            if current_number + 1 == 9:
                ...
                score = scan(add_lists(position,direction),map,current_number+1,score)
